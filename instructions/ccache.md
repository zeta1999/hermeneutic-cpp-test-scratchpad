...
- download caches (FetchContent) should land in .deps-cache/<platform>/ (gitignored) with optional HERMENEUTIC_DEPS_DIR override; docker builds must mount the same path.
