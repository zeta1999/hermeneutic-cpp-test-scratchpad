...
| Deliverables: code repo, Dockerfiles per service, compose topology (PDF) | `docker/Dockerfile.*`, `docker/compose.yml`, `scripts/docker_run.sh` | README “Docker + demo stack” instructions | ✅ |
